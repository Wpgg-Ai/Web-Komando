...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE anggota 
            SET nama='$nama', email='$email', nim='$nim', jabatan='$jabatan', tanggal_bergabung='$tanggal' 
            WHERE id=$id";
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="bg-white shadow-lg rounded-lg w-full max-w-lg p-8">
        <h2 class="text-2xl font-bold text-gray-800 mb-6">Edit Anggota</h2>
        <form method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="date" name="tanggal" value="<?= $row['tanggal_bergabung'] ?>" 
                       class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500">
            </div>
